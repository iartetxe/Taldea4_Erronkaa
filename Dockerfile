...
# 2. Instalar dependencias del sistema, Node.js y herramientas de compresión
...
# 5. Configurar el DocumentRoot a la carpeta public de tu subproyecto
...
# 10. Permisos finales para el servidor web
